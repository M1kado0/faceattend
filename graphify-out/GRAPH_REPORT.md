# Graph Report - faceguard  (2026-09-08)

## Corpus Check
- 234 files · ~276,443 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2319 nodes · 4407 edges · 224 communities (155 shown, 69 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 1470 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c0e0ff6d`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Media Pipe Active Liveness|Media Pipe Active Liveness]]
- [[_COMMUNITY_Fake Session|Fake Session]]
- [[_COMMUNITY_Ml Client.Py|Ml Client.Py]]
- [[_COMMUNITY_Faissstore|Faissstore]]
- [[_COMMUNITY_Test Attendance Routes.Py|Test Attendance Routes.Py]]
- [[_COMMUNITY_Liveness Gated Check In|Liveness Gated Check In]]
- [[_COMMUNITY_Mini Fasnet.Py|Mini Fasnet.Py]]
- [[_COMMUNITY_Active Liveness Challenge|Active Liveness Challenge]]
- [[_COMMUNITY_Sqlmodel|Sqlmodel]]
- [[_COMMUNITY_Current Enrollment And Search|Current Enrollment And Search]]
- [[_COMMUNITY_Fast Api Backend Api|Fast Api Backend Api]]
- [[_COMMUNITY_Base Model|Base Model]]
- [[_COMMUNITY_Backend Client|Backend Client]]
- [[_COMMUNITY_Mini Fasnet|Mini Fasnet]]
- [[_COMMUNITY_Attendance.Py|Attendance.Py]]
- [[_COMMUNITY_Ml Test Fixtures. Only|Ml Test Fixtures. Only]]
- [[_COMMUNITY_Webcam.Js|Webcam.Js]]
- [[_COMMUNITY_Auth.Py|Auth.Py]]
- [[_COMMUNITY_Base Spider|Base Spider]]
- [[_COMMUNITY_Api.Py|Api.Py]]
- [[_COMMUNITY_Users.Py|Users.Py]]
- [[_COMMUNITY_Hash.Py|Hash.Py]]
- [[_COMMUNITY_Test Face Pipeline.Py|Test Face Pipeline.Py]]
- [[_COMMUNITY_Threshold Calibration|Threshold Calibration]]
- [[_COMMUNITY_Face Registrations.Py|Face Registrations.Py]]
- [[_COMMUNITY_Example Spider|Example Spider]]
- [[_COMMUNITY_Email Fallback|Email Fallback]]
- [[_COMMUNITY_Rate Limit.Py|Rate Limit.Py]]
- [[_COMMUNITY_Request Logging Middleware|Request Logging Middleware]]
- [[_COMMUNITY_Notifications.Py|Notifications.Py]]
- [[_COMMUNITY_Estimate Head Pose()|Estimate Head Pose()]]
- [[_COMMUNITY_Facemesh.Py|Facemesh.Py]]
- [[_COMMUNITY_Session.Py|Session.Py]]
- [[_COMMUNITY_Robots Check.Py|Robots Check.Py]]
- [[_COMMUNITY_Proxy Rotation.Py|Proxy Rotation.Py]]
- [[_COMMUNITY_Dedup.Py|Dedup.Py]]
- [[_COMMUNITY_Image Download.Py|Image Download.Py]]
- [[_COMMUNITY_Phash.Py|Phash.Py]]
- [[_COMMUNITY_Queue Emit.Py|Queue Emit.Py]]
- [[_COMMUNITY_Notifier.Py|Notifier.Py]]
- [[_COMMUNITY_Match Diff.Py|Match Diff.Py]]
- [[_COMMUNITY_Render Notice()|Render Notice()]]
- [[_COMMUNITY_Exporter.Py|Exporter.Py]]
- [[_COMMUNITY_D4F6A8B2C9E1 Rename Biometric Tables|D4F6A8B2C9E1 Rename Biometric Tables]]
- [[_COMMUNITY_E7A4D91F2B63 Create Attendance Sessions.Py|E7A4D91F2B63 Create Attendance Sessions.Py]]
- [[_COMMUNITY_Get Current User()|Get Current User()]]
- [[_COMMUNITY_Attendance Records.Py|Attendance Records.Py]]
- [[_COMMUNITY_Legacy Source Level Takedown|Legacy Source Level Takedown]]
- [[_COMMUNITY_Main.Py|Main.Py]]
- [[_COMMUNITY_Billing.Py|Billing.Py]]
- [[_COMMUNITY_Priority.Py|Priority.Py]]
- [[_COMMUNITY_Recrawl.Py|Recrawl.Py]]
- [[_COMMUNITY_Recrawl Scheduler.Py|Recrawl Scheduler.Py]]
- [[_COMMUNITY_Tracker.Py|Tracker.Py]]
- [[_COMMUNITY_Session.Py|Session.Py]]
- [[_COMMUNITY_Main.Py|Main.Py]]
- [[_COMMUNITY_Rbac.Py|Rbac.Py]]
- [[_COMMUNITY_Billing.Py|Billing.Py]]
- [[_COMMUNITY_Reembed.Py|Reembed.Py]]
- [[_COMMUNITY_Purge Domain.Py|Purge Domain.Py]]
- [[_COMMUNITY_Cluster Eval.Py|Cluster Eval.Py]]
- [[_COMMUNITY_Calibrate Liveness.Py|Calibrate Liveness.Py]]
- [[_COMMUNITY_Face Attend|Face Attend]]
- [[_COMMUNITY_Settings.Py|Settings.Py]]
- [[_COMMUNITY_Architecture Decision Record Template|Architecture Decision Record Template]]
- [[_COMMUNITY_Insight Face Buffalo L|Insight Face Buffalo L]]
- [[_COMMUNITY_Silent Face Anti Spoofing|Silent Face Anti Spoofing]]
- [[_COMMUNITY_Iso Iec 30107 3|Iso Iec 30107 3]]
- [[_COMMUNITY_Gdpr Article 9|Gdpr Article 9]]
...
- [[_COMMUNITY_Min Io|Min Io]]
- [[_COMMUNITY_Qdrant|Qdrant]]
- [[_COMMUNITY_Face Attend Learnings Scratchpad|Face Attend Learnings Scratchpad]]
- [[_COMMUNITY_Media Pipe Face Landmarker|Media Pipe Face Landmarker]]
...
1. `Frame` - 121 edges
2. `FrameEvidence` - 83 edges
3. `ActiveLivenessChallengeEvaluator` - 66 edges
4. `FaceObservation` - 63 edges
5. `ModelMetadata` - 55 edges
6. `LivenessEvidence` - 52 edges
7. `TemporalPassiveLivenessSession` - 51 edges
8. `ActiveLivenessConfig` - 49 edges
9. `HeadPose` - 49 edges
10. `MediaPipeLivenessSession` - 45 edges

## Surprising Connections (you probably didn't know these)
- `Liveness Before Registration and Check-In` --semantically_similar_to--> `Current Enrollment and Search Pipeline`  [INFERRED] [semantically similar]
  backend/AGENTS.md → ml/AGENTS.md
- `test_desktop_lifecycle_has_explicit_start_cancel_error_and_shutdown_states()` --calls--> `DesktopLifecycle`  [INFERRED]
  tests/unit/test_desktop_runtime.py → src/faceattend/application/runtime.py
- `test_mediapipe_matrix_estimator_handles_turns_and_pitch()` --calls--> `MediaPipeMatrixHeadPoseEstimator`  [INFERRED]
  tests/unit/test_head_pose.py → src/faceattend/vision/head_pose.py
- `test_lazy_model_factory_runs_once()` --calls--> `LazyModel`  [INFERRED]
  tests/unit/test_head_pose.py → src/faceattend/vision/model_lifecycle.py
- `Legacy ML Crawler Ingest Pipeline` --semantically_similar_to--> `Legacy Crawler Ingest Pipeline`  [INFERRED] [semantically similar]
  ml/AGENTS.md → crawler/AGENTS.md

## Hyperedges (group relationships)
- **Verified Attendance Flow** — concept_face_registration, concept_attendance_session, concept_liveness_gated_check_in, concept_identity_matching, concept_biometric_audit_log [EXTRACTED 1.00]
- **Python-First Frontend Stack** — service_frontend_site, concept_python_first_frontend, concept_html_over_json, concept_webcam_js_exception, template_base_layout [EXTRACTED 1.00]
- **FaceAttend Observability Stack** — service_prometheus, service_grafana, prometheus_faceattend_scrapes, service_frontend_site, service_backend_api, service_ml [INFERRED 0.90]
- **Current Biometric Attendance Flow** — attendance_api_scope, liveness_before_biometrics, face_registration_flow, current_enrollment_search_pipeline, append_only_audit_log [EXTRACTED 1.00]
...
Cohesion: 0.05
Nodes (52): _axis_errors(), PoseValidationSample, PoseValidationSummary, Compare estimated head poses with controlled reference poses., One known-pose observation used for validation., Aggregate error and pass/fail results for a validation set., Summarize pose errors against controlled reference angles.      A sample passes, validate_pose_samples() (+44 more)

### Community 1 - "Fake Session"
Cohesion: 0.06
Nodes (47): _detector(), _face(), _frame(), Tests for the headless MiniFASNet passive-liveness adapter., test_passive_liveness_fails_on_lowest_frame_score(), test_passive_liveness_loads_model_once(), test_passive_liveness_passes_only_when_all_window_frames_pass(), test_passive_liveness_rejects_invalid_model_score() (+39 more)
...
Cohesion: 0.09
Nodes (47): evidence(), Exercise real evidence guards and active/PAD composition with synthetic pixels., runtime(), test_active_then_pad_success_and_native_pad_failure(), test_camera_callable_converts_processor_exception_to_terminal_failure(), test_composed_stream_rejects_invalid_evidence(), test_embedding_and_matching_callbacks_never_run_after_liveness_failure(), test_embedding_and_matching_run_in_order_only_after_both_liveness_gates_pass() (+39 more)

### Community 4 - "Test Attendance Routes.Py"
Cohesion: 0.1
Nodes (32): Protocol, TypedDict, test_artifact_rejects_changed_weights_even_if_metadata_still_matches(), test_missing_artifact_is_rejected(), test_unpinned_manifest_is_rejected(), ModelArtifact, _ModelOptions, Expected identity, pinned independently of an adapter's self-reported hash. (+24 more)

### Community 5 - "Liveness Gated Check In"
Cohesion: 0.05
Nodes (36): MediaPipeLivenessSession, Discard action history at attempt/challenge boundaries., Discard action history at attempt/challenge boundaries., Runtime composition of MediaPipe active actions and temporal passive PAD., Runtime composition of MediaPipe active actions and temporal passive PAD., Finalize PAD only after active liveness has completed., Runtime composition of MediaPipe active actions and temporal passive PAD., Finalize PAD only after active liveness has completed. (+28 more)

### Community 6 - "Mini Fasnet.Py"
Cohesion: 0.08
Nodes (43): ActiveLivenessConfig, MediaPipeActionEvidence, Convert real Face Landmarker landmarks/blendshapes into actions., Convert real Face Landmarker landmarks/blendshapes into actions., Convert real Face Landmarker landmarks/blendshapes into actions., Convert real Face Landmarker landmarks/blendshapes into actions., Convert real Face Landmarker landmarks/blendshapes into actions., Convert real Face Landmarker landmarks/blendshapes into actions. (+35 more)
...
Cohesion: 0.13
Nodes (30): BlinkCounter, BlinkTurnLeftRightChallenge, LivenessRuntimePhase, LivenessSessionResult, NeutralPadConfig, User-visible stages of the combined active and passive session., Requirements for the dedicated post-active neutral PAD window., Overall decision: an active pass alone never means the attempt passed. (+22 more)
...
### Community 13 - "Mini Fasnet"
Cohesion: 0.17
Nodes (24): Coordinate one consented registration without owning camera or GUI state., RegistrationCoordinator, RegistrationRequest, Desktop-session adapter for the headless registration coordinator., Expose registration to the Phase 4 inference-worker contract., RegistrationDesktopSessionProcessor, Embedder, _evidence() (+16 more)
...
Cohesion: 0.08
Nodes (22): CameraCaptureError, CameraEvidenceWorker, Small headless camera worker that forwards frames to an evidence builder., Raised when a camera cannot be opened or stops producing frames., Own OpenCV capture and emit one shared evidence record per frame.      The proce, RuntimeError, _draw_blink_scores(), _draw_face_landmarks() (+14 more)

### Community 16 - "Webcam.Js"
Cohesion: 0.06
Nodes (34): 1. Configure environment, 2. Start dependencies, 3. Run migrations, 4. Start services, 5. Browser flow, 6. Failure cases to demo, Architecture, code:text (register a consenting face) (+26 more)
...
Cohesion: 0.11
Nodes (24): _FixedRandom, test_runtime_session_finalizes_passive_pad_after_active_completion(), test_pose_estimator_protocol_adapter_uses_frame_dimensions(), test_frame_and_observation_are_typed_transient_values(), test_geometric_quality_gates(), test_measured_sharpness_distinguishes_blur_and_reports_exposure(), test_occlusion_signals_are_advisory_not_glasses_or_mask_diagnoses(), test_quality_config_rejects_invalid_thresholds() (+16 more)

### Community 19 - "Api.Py"
Cohesion: 0.14
Nodes (25): test_runtime_session_cannot_finalize_pad_before_active_completion(), _evidence(), _FixedSequenceRandom, _pose(), test_challenge_and_session_timeouts_are_explicit(), test_challenge_timeout_is_checked_during_directional_dwell(), test_evidence_boundary_completes_action_challenge(), test_evidence_boundary_reports_invalid_pose() (+17 more)

### Community 20 - "Users.Py"
Cohesion: 0.08
Nodes (24): _decode_video(), _eye_aspect_ratio(), _frame_timestamp_ms(), _landmark_xy(), MediaPipe-backed active liveness checks., Tuning knobs for blink-based active liveness., Raised when a liveness video cannot be decoded., Tuning knobs for blink-based active liveness. (+16 more)

### Community 21 - "Hash.Py"
Cohesion: 0.11
Nodes (15): Immutable facts rendered by Qt; widgets never award progress., SessionPresentation, _Capture, _CompletingProcessor, _Processor, Offscreen integration tests for Qt camera and inference ownership., _SlowProcessor, test_runtime_reports_camera_and_model_startup_failures() (+7 more)
...
Cohesion: 0.1
Nodes (18): ActiveLivenessChallengeEvaluator, _opposite(), Observe the shared session before any evidence branch.          Returns False wh, Observe the shared session before any evidence branch.          Returns False wh, Observe the shared session before any evidence branch.          Returns False wh, Consume the active-liveness fields from one frame evidence record., Consume the active-liveness fields from one frame evidence record., Consume the active-liveness fields from one frame evidence record. (+10 more)
...
Cohesion: 0.09
Nodes (7): MediaPipeDesktopSessionProcessor, Desktop presentation adapter for the existing MediaPipe liveness runtime., Expose Phase 2 liveness as the inference worker's session contract., _evidence(), Presentation bridge tests for the existing Phase 2 liveness runtime., _Session, test_adapter_uses_session_instruction_progress_and_neutral_guidance()
...
Cohesion: 0.11
Nodes (18): main(), PersistenceSmokeResult, Run a non-biometric end-to-end smoke test of local persistence and matching., Exercise the Phase 3 public boundaries using synthetic embeddings., run_smoke(), _template(), _unit_vector(), Behavior tests for exact person-level cosine matching. (+10 more)
...
Cohesion: 0.12
Nodes (14): One inference-thread-owned liveness/application attempt., SessionProcessor, CameraWorker, cancel(), capture_once(), infer_once(), InferenceWorker, Qt worker objects that exclusively own capture and inference resources. (+6 more)
...
Cohesion: 0.11
Nodes (11): _action_name(), EnrollmentFaceAnalyzer, EnrollmentSession, _pose_bin(), _pose_distance(), Headless registration orchestration for the local desktop application., Consume a frame and complete persistence only after both liveness gates., Replace a terminal attempt with a fresh liveness session. (+3 more)
...
Cohesion: 0.16
Nodes (11): DesktopMode, Headless lifecycle and presentation contracts for the desktop runtime., MainWindow, AttendanceView, HomeView, Dumb Qt Widgets that render desktop runtime state., Present session facts; contains no CV decisions or model inference., RegistrationView (+3 more)

### Community 34 - "Proxy Rotation.Py"
Cohesion: 0.12
Nodes (14): ApiKey, SQLModel: api_keys — programmatic access tokens., AuditLog, SQLModel: audit_log — append-only audit trail.  Row-level retention guarantees e, Cluster, SQLModel: clusters — face cluster metadata., SQLModel: face_registrations — user to face embedding ID link., SQLModel: takedowns — takedown requests + status. (+6 more)

### Community 35 - "Dedup.Py"
Cohesion: 0.13
Nodes (16): test_matrix_estimator_uses_degrees_without_arbitrary_scaling(), _camera_matrix(), estimate_matrix_head_pose(), estimate_solvepnp_head_pose(), _landmark_xy(), Validated, framework-independent head-pose estimators.  The legacy ``ml.liveness, Estimate pose from six landmarks and a canonical 3D face model.      Angles are, Estimate pose from six landmarks and a canonical 3D face model.      Angles are (+8 more)
...
Cohesion: 0.17
Nodes (14): ActiveSessionView, ChallengeEvaluatorView, ChallengeProgress, MediaPipeSessionView, RuntimePhase, RuntimeStatus, FrameEvidenceProcessor, ContinuityStatus (+6 more)
...
Cohesion: 0.12
Nodes (12): MediaPipeChallengeSessionAdapter, Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator., Bridge MediaPipe action evidence into the headless challenge evaluator. (+4 more)
...
Cohesion: 0.16
Nodes (10): test_embedder_loads_model_once(), InsightFaceEmbedder, Generate normalized embeddings from already-aligned face images.      The input, file_sha256(), LazyModel, Headless, lazy model lifecycle shared by inference adapters and tests., Load one model on first use and reuse it for the application lifetime., Load one model on first use and reuse it for the application lifetime. (+2 more)

### Community 45 - "Get Current User()"
Cohesion: 0.19
Nodes (6): _camera_started(), DesktopRuntime, _inference_started(), _presentation_received(), Thread orchestration for the local PySide6 runtime., Own two QThreads and expose queued signals to the main-thread GUI.

### Community 46 - "Attendance Records.Py"
Cohesion: 0.12
Nodes (15): 2026-09-07 — Phase 4 — PySide6 shell and concurrency completed, 2026-09-08 — Phase 5 — Enrollment workflow completed, Current decision record, Current decisions and boundaries, FaceAttend Local-First Migration Plan, How to track progress, Latest execution record, Phase 4 — PySide6 shell and runtime concurrency (+7 more)

### Community 47 - "Legacy Source Level Takedown"
Cohesion: 0.22
Nodes (6): test_timestamps_must_be_strictly_increasing(), ChallengeSession, Generate and track one ordered, time-bounded challenge sequence.      CV evidenc, Generate and track one ordered, time-bounded challenge sequence.      CV evidenc, Generate and track one ordered, time-bounded challenge sequence.      CV evidenc, Generate and track one ordered, time-bounded challenge sequence.      CV evidenc

### Community 48 - "Main.Py"
Cohesion: 0.32
Nodes (4): LivenessResult, _average_eye_aspect_ratio(), _failed(), MediaPipeActiveLivenessChecker

### Community 49 - "Billing.Py"
Cohesion: 0.24
Nodes (12): _face(), _frame(), Tests for the five-point face alignment adapter., test_align_rejects_invalid_frame(), test_align_rejects_nonfinite_landmarks(), test_align_rejects_wrong_landmark_shape(), test_align_returns_arcface_sized_bgr_image(), AlignmentError (+4 more)
...
Cohesion: 0.18
Nodes (7): LatestFrameBuffer, Thread-safe capacity-one handoff between capture and inference., Keep only the newest valid frame so inference latency cannot accumulate., _frame(), Behavior tests for capacity-one camera-to-inference backpressure., test_latest_frame_buffer_rejects_non_monotonic_and_expired_frames(), test_latest_frame_buffer_replaces_stale_work_instead_of_queueing()
...
Cohesion: 0.18
Nodes (7): CallbackSessionProcessor, Adapt the existing Phase 2 processor/session without importing Qt., _evidence(), Headless desktop-runtime contracts shared with Qt workers., test_callback_adapter_reuses_headless_processor_and_presentation_evidence(), test_desktop_lifecycle_has_explicit_start_cancel_error_and_shutdown_states(), test_presentation_progress_is_derived_from_session_completion()
...
Cohesion: 0.23
Nodes (8): _arguments(), _artifact(), _FixedChallengeSource, main(), _manifest(), Run one consented local liveness trial without retaining camera images.  Example, Preserve an explicitly requested diagnostic challenge sequence., Preserve an explicitly requested diagnostic challenge sequence.

### Community 56 - "Rbac.Py"
Cohesion: 0.2
Nodes (8): ChallengeSessionSnapshot, RandomSource, Short-lived randomized active-liveness challenge sessions., Auditable public state of a challenge session., Auditable public state of a challenge session., Auditable public state of a challenge session., Auditable public state of a challenge session., snapshot()

### Community 57 - "Billing.Py"
Cohesion: 0.18
Nodes (11): _matches_action(), _phase_for_action(), Calibration-aware, headless active-liveness challenge evaluation., Map randomized session actions to evaluator phases., Map randomized session actions to evaluator phases., Map randomized session actions to evaluator phases., Map randomized session actions to evaluator phases., Map randomized session actions to evaluator phases. (+3 more)
...
Cohesion: 0.27
Nodes (8): _evenly_sample(), Helpers for sampling frames from short webcam videos., Raised when a check-in video cannot be sampled., sample_video_frames_as_jpegs(), VideoFrameDecodeError, analyze_video_passive_liveness(), Shared liveness helpers for short webcam challenge videos., Sample frames, run passive liveness, and choose a live frame for embedding.

### Community 69 - "Init .Py"
Cohesion: 0.29
Nodes (6): Primary Qt window for mode selection and session presentation., _show_error(), _show_presentation(), _show_preview(), _show_runtime_status(), start_mode()
...
Cohesion: 0.33
Nodes (8): _projected_landmarks(), Deterministic validation for the new headless pose boundary., test_invalid_pose_inputs_raise_head_pose_error(), test_lazy_model_factory_runs_once(), test_matrix_and_solvepnp_agree_on_controlled_pose(), test_mediapipe_matrix_estimator_handles_turns_and_pitch(), test_pose_comparison_rejects_invalid_matrix_or_landmarks(), test_solvepnp_recovers_known_pose()
...
Cohesion: 0.33
Nodes (4): MediaPipeFrameLandmarker, Expose raw expression evidence without coupling core types to MediaPipe., Synchronous VIDEO-mode matrix/action adapter; one instance per capture stream., Synchronous VIDEO-mode matrix/action adapter; one instance per capture stream.
...
Cohesion: 0.25
Nodes (3): EmbeddingError, Headless InsightFace recognition-model adapter., Raised when an aligned face cannot produce a usable embedding.
...
Cohesion: 0.53
Nodes (5): _embedder(), Tests for the injectable InsightFace recognition adapter., test_embedder_normalizes_recognition_output_and_exposes_metadata(), test_embedder_rejects_invalid_aligned_image(), test_embedder_rejects_zero_or_nonfinite_output()
...
Cohesion: 0.4
Nodes (3): FakeScalarResult, _passing_video_summary(), VideoLivenessSummary
...
Cohesion: 0.7
Nodes (4): _frame(), test_duplicate_detector_flags_repeated_pixels_only_within_history(), test_frame_evidence_rejects_inconsistent_face_count(), test_frame_evidence_rejects_invalid_signal_ranges()
...
Cohesion: 0.4
Nodes (3): Close native MediaPipe resources; no camera ownership or persistence., Close native MediaPipe resources; no camera ownership or persistence., Close native MediaPipe resources; no camera ownership or persistence.
...
Cohesion: 0.5
Nodes (3): Answer, Q: What did FaceAttend Phase 5 implement?, Source Nodes
...
## Knowledge Gaps
- **765 isolated node(s):** `Public site (port 8000) — end-user-facing FastAPI + Jinja2 + HTMX app.`, `Public site auth routes — /login, /register, /verify.`, `/billing — Stripe-backed plan management.`, `/attendance — attendance result dashboard + detail.`, `/face-registration — register a consenting face for attendance.` (+760 more)
...
- **Why does `Frame` connect `Phash.Py` to `Fake Session`, `Faissstore`, `Test Attendance Routes.Py`, `Liveness Gated Check In`, `Mini Fasnet.Py`, `Current Enrollment And Search`, `Mini Fasnet`, `Ml Test Fixtures. Only`, `Base Spider`, `Api.Py`, `Users.Py`, `Hash.Py`, `Example Spider`, `Request Logging Middleware`, `Notifications.Py`, `Facemesh.Py`, `Robots Check.Py`, `Match Diff.Py`, `Main.Py`, `Billing.Py`, `Recrawl.Py`, `Recrawl Scheduler.Py`, `Tracker.Py`, `Reembed.Py`, `Purge Domain.Py`, `Calibrate Liveness.Py`, `Init .Py`, `Init .Py`, `Init .Py`, `Init .Py`, `Init .Py`, `Community 103`, `Community 110`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `FrameEvidence` connect `Phash.Py` to `Fake Session`, `Faissstore`, `Test Attendance Routes.Py`, `Liveness Gated Check In`, `Mini Fasnet.Py`, `Current Enrollment And Search`, `Mini Fasnet`, `Ml Test Fixtures. Only`, `Api.Py`, `Users.Py`, `Hash.Py`, `Threshold Calibration`, `Example Spider`, `Request Logging Middleware`, `Notifications.Py`, `Facemesh.Py`, `Robots Check.Py`, `Match Diff.Py`, `D4F6A8B2C9E1 Rename Biometric Tables`, `Main.Py`, `Tracker.Py`, `Main.Py`, `Cluster Eval.Py`, `Calibrate Liveness.Py`, `Init .Py`, `Community 110`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `FakeScalarResult` connect `Community 108` to `Media Pipe Active Liveness`, `Proxy Rotation.Py`, `Queue Emit.Py`, `Notifier.Py`, `Attendance.Py`, `Init .Py`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 117 inferred relationships involving `Frame` (e.g. with `PAD` and `_Session`) actually correct?**
  _`Frame` has 117 INFERRED edges - model-reasoned connections that need verification._
- **Are the 79 inferred relationships involving `FrameEvidence` (e.g. with `_Capture` and `_UnavailableCapture`) actually correct?**
  _`FrameEvidence` has 79 INFERRED edges - model-reasoned connections that need verification._
- **Are the 50 inferred relationships involving `ActiveLivenessChallengeEvaluator` (e.g. with `PAD` and `_FixedSequenceRandom`) actually correct?**
  _`ActiveLivenessChallengeEvaluator` has 50 INFERRED edges - model-reasoned connections that need verification._
- **Are the 62 inferred relationships involving `FaceObservation` (e.g. with `PAD` and `PassedLivenessSession`) actually correct?**
  _`FaceObservation` has 62 INFERRED edges - model-reasoned connections that need verification._