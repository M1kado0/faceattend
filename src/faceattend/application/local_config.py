...
class LocalAppConfig:
    ...
    def from_environment(cls, root: Path) -> LocalAppConfig:
        """Use explicit environment overrides with repository-local dev defaults.
        ...
        return cls(
            ...
            # Do not default to a machine-specific camera. Set FACEATTEND_CAMERA_INDEX=1 locally.
